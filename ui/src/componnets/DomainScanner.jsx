...
const styles = {
    ...
    searchIcon: { position: "absolute", left: 10, fontSize: 14, opacity: 0.7, pointerEvents: "none" },
    input: { width: "100%", border: "none", outline: "none", fontSize: 14, background: "transparent" },
    button: {
        height: 44, borderRadius: 12, border: "1px solid #d9e0e7",
        background: "#f7f9fc", cursor: "pointer", fontWeight: 600,
    },
    buttonDisabled: { opacity: 0.6, cursor: "not-allowed" },
    progressBar: { position: "relative", height: 6, overflow: "hidden", background: "#eef1f4", borderRadius: 999 },
    progressIndeterminate: {
        position: "absolute", top: 0, left: 0, bottom: 0, width: "30%",
        transform: "translateX(-100%)", animation: "indet 1.2s linear infinite",
        background: "#2b6ff7", borderRadius: 999,
    },
    note: {fontSize: 13},
};
